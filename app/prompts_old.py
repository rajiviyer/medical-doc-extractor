...
- policy_start_date: Policy start date (in DD/MM/YYYY format if found)
- policy_end_date: Policy end date (in DD/MM/YYYY format if found)
- date_of_admission: Date of admission to hospital (in DD/MM/YYYY format if found)
